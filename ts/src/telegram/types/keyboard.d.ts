declare namespace tgTypes {
    ...
    interface KeyboardButton {
        ...
        /**
         * _Optional_. If True, the user's current location will be sent when the button is pressed. Available in private chats only.
         */
    ...
    interface InlineKeyboardButton {
        ...
        text: string;
        /**
         * _Optional_. HTTP or tg:// URL to be opened when the button is pressed.
        ...
        url?: string;
        /**
         * _Optional_. Data to be sent in a [callback query](https://core.telegram.org/bots/api#callbackquery)
         * to the bot when the button is pressed, 1-64 bytes
         */
        callback_data?: string;
        /**
         * _Optional_. Description of the [Web App](https://core.telegram.org/bots/webapps)
        ...
        /**
         * _Optional_. If set, pressing the button will insert the bot's username and the specified inline query in the current chat's input field.
        ...
        /**
         * _Optional_. If set, pressing the button will prompt the user to select one of their chats of the specified type,
         * open that chat and insert the bot's username and the specified inline query in the input field.
         * Not supported for messages sent on behalf of a Telegram Business account.
         */
    ...
    interface CallbackQuery {
        ...
        /**
         * _Optional_. Data associated with the callback button.
